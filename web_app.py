...
</style></head><body><main class="wrap"><h1>Patient Report Generator</h1><p class="meta">Your JSON and AI analysis stay on this computer. Reports are saved to <code>Saved/</code>.</p>
